...
const skillList = [
    ...
    },
    {
      ...
      skills: [
        { name: "React.js", imageUrlName: "react" },
        { name: "Node.js", imageUrlName: "nodejs" },
        { name: "HTML", imageUrlName: "html5" },
        { name: "CSS", imageUrlName: "css3" },
    ...
    },
    {
      title: "Frameworks",
      skills: [
        { name: "Xamarin.Forms", imageUrlName: "xamarin" },
        { name: "Spring", imageUrlName: "spring" },
        { name: "Junit", imageUrlName: "junit5" },
        { name: "Dotnet", imageUrlName: "dotnet" },
      ],
    },
  ];
