  ...
  return (
    <div>
      ...
      <div className="h-screen bg-[#f0f4f4] flex justify-center items-center">
        <div className="flex flex-col lg:flex-row mx-24 gap-4 items-center">
          {/* About Me */}
          <div className="w-full md:w-8/12 m-5 flex flex-col items-center justify-center px-16">
          ...
          {/* My photo */}
          <div className="m-5 w-full lg:w-4/12 flex justify-center items-center">
            <img
              className="rounded-full drop-shadow-xl object-cover shadow-slate-500"
              src={profileImage}
              alt="Damyant Jain"
            />
          </div>
