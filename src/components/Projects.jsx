          ...
          >
            <motion.div variants={itemVariants}>
              <div className="h-80 md:h-96 lg:h-[420px] 2xl:h-[460px]">
                <div className="w-full rounded-xl bg-slate-100 h-48 md:h-64 xl:h-72 2xl:h-[340px]">
                  <img className="p-3 w-full h-full rounded-3xl object-cover" src={imageMap[project.image]} alt={project.name} />
                </div>
