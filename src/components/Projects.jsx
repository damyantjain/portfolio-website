const Projects = () => {
  ...
  return (
    <div className="align-middle text-center font-poppins text-4xl font-bold text-[#333333]">
      <div>My Projects</div>
      {/* List of Projects */}
      <div className="grid grid-cols-3 gap-2 lg:gap-8 mt-4 lg:mt-20">
        {projects.map((project, index) => {
          return (
            <div key={index} className="hover:cursor-pointer hover:scale-95 transition-transform duration-500 ease-in-out">
              {/* Project Image */}
